  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <span className="text-primary text-sm font-medium uppercase tracking-wider">Crypto Insights</span>
          <h1 className="font-heading text-4xl md:text-5xl font-bold mt-4 mb-6">
            Latest Articles & <span className="text-gradient">Analysis</span>
          </h1>
          <p className="text-slate-400 text-lg">
            Stay informed with expert insights on cryptocurrency, blockchain technology, and market trends.
          </p>
        </motion.div>
